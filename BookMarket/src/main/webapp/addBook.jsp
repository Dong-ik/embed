			...
			<div class="row align-items-md-stretch">
				...
				<form action="./processAddBook.jsp" name="newBook" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-3">
							<textarea id="description" name="description" class="form-control" cols="50" rows="5" placeholder="5자 이상 적어주세요."></textarea>
						</div>
					</div>
					<div class="mb-3 row">
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-5">
							...
							<input type="radio" id="condition" name="condition" value="EBook"> <fmt:message key="condition_Ebook"/>
						</div>
					</div>
